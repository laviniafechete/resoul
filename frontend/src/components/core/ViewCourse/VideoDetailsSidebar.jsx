...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  return (
    <>
      <div className="flex h-[calc(100vh-3.5rem)] min-w-[220px] flex-col border-r-[1px] border-r-brand-primary bg-lavander-100 py-10">
        <div className="mx-5 flex flex-col items-start justify-between gap-2 gap-y-4 py-5 text-lg font-bold text-richblack-25">
          <div className="flex w-full items-center justify-between ">
            ...
            <button
              ...
              className="flex h-[35px] w-[35px] items-center justify-center rounded-full bg-richblack-100 p-1 m-2 text-richblack-700 hover:scale-90"
              title="back"
            >
        ...
        <div className="h-[calc(100vh - 5rem)] overflow-y-auto">
          {courseSectionData.map((section, index) => (
            ...
            >
              {/* Section */}
              <div className="flex justify-between bg-brand-primary text-white px-5 py-4">
                    ...
                    <div
                      className={`flex gap-3  px-5 py-2 ${
                        videoBarActive === topic._id
                          ? "font-semibold text-richblack-300"
