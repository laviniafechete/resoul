    ...
    <div className="bg-richblack-800 mx-7 rounded-3xl mb-10">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          {/* Section 1 */}
          <div className="lg:w-[100%] flex flex-wrap flex-row justify-between pl-3 lg:pr-5 gap-3">
            <div className="w-[33%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0 text-center">
              <Link to="/">
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  return (
                    ...
                    >
                      <Link to={ele.path.toLowerCase()}>{ele.title}</Link>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="w-[33%] lg:w-[30%] mb-7 lg:pl-0 text-center">
