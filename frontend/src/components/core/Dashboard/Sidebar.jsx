    ...
    <>
      ...
      {openSideMenu && (
        <div className="flex h-[calc(100vh-3.5rem)] min-w-[220px] flex-col border-r-[1px] border-r-brand-primary bg-lavander-100 py-10 ">
          ...
          <div className="mx-auto mt-6 mb-6 h-[1px] w-10/12 bg-brand-primary" />

          <div className="flex flex-col">
            <SidebarLink
              link={{ name: "Setari", path: "/dashboard/settings" }}
            ...
            <button
              onClick={() =>
                setConfirmationModal({
                  text1: "Esti sigur?",
                  text2: "Vei fi deconectat din cont.",
                  btn1Text: "Deconecteaza",
                  btn2Text: "Anuleaza",
