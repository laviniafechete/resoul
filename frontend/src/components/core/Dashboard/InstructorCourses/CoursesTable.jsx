...
export default function CoursesTable({
  ...
  const skItem = () => {
    return (
      <div className="flex border-b border-brand-primary px-6 py-8 w-full">
  ...
  return (
    <>
      <Table className="rounded-2xl border border-brand-primary ">
        {/* heading */}
        <Thead>
          <Tr className="flex gap-x-10 rounded-t-3xl border-b border-b-brand-primary px-6 py-2">
              ...
              >
                <Td className="flex flex-1 gap-x-4 relative">
                  ...
                  <div className="flex flex-col">
                    ...
                    {/* created At */}
                    <p className="text-[12px] text-richblack-300 mt-4">
                      Creat la: {formatDate(course?.createdAt)}
                    </p>

                    {/* updated At */}
                    <p className="text-[12px] text-richblack-300 ">
                      Actualizat la: {formatDate(course?.updatedAt)}
                    </p>
